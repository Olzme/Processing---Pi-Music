...
public class pi_music_umm_hmm extends PApplet {
...
public void playnote() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "pi_music_umm_hmm" };
    if (passedArgs != null) {
